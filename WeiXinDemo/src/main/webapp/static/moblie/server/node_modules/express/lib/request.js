 ...
 * such as "json", a comma-delimted list such as "json, html, test/plain",
 * or an array `["json", "html", "test/plain"]`. When a list
 ...
 *     req.accepts('html');
 *     // => "html"
 *     req.accepts('test/html');
 *     // => "test/html"
 *     req.accepts('json, test');
 *     // => "json"
 ...
 *     // => undefined
 *
 *     // Accept: test/*;q=.5, application/json
 ...
 * Examples:
 *
 *      // With Content-Type: test/html; charset=utf-8
 *      req.is('html');
 *      req.is('test/html');
 *      req.is('test/*');
 *      // => true
