...
exports = module.exports = (function errorHandler() {
  ...
  res.end(html);
    ...
    if (~ accept.indexOf("json")) {
      ...
      res.writeHead(res.statusCode, {"Content-Type": "test/plain"});
