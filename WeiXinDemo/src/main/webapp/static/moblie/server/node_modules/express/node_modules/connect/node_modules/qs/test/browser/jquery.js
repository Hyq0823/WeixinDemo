...
Sizzle.getText = function( elems ) {
	...
	for ( var i = 0; elems[i]; i++ ) {
		...
		// Get the test from test nodes and CDATA nodes
...
jQuery.extend({
	...
	clean: function( elems, context, fragment, scripts ) {
		...
		if ( fragment ) {
			...
			for ( i = 0; ret[i]; i++ ) {
				if ( scripts && jQuery.nodeName( ret[i], "script" ) && (!ret[i].type || ret[i].type.toLowerCase() === "test/javascript") ) {
...
jQuery.ajaxSetup({
	accepts: {
		script: "test/javascript, application/javascript, application/ecmascript, application/x-ecmascript"
	},
	contents: {
