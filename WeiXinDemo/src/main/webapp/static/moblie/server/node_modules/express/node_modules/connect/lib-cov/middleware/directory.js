...
exports = module.exports = (function directory(root, options) {
  ...
  var accept = req.headers.accept || "test/plain", url = parse(req.url), dir = decodeURIComponent(url.pathname), path = normalize(join(root, dir)), originalUrl = parse(req.originalUrl), originalDir = decodeURIComponent(originalUrl.pathname), showUp = path != root && path != root + "/";
