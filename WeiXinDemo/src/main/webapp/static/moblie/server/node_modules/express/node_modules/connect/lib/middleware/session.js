 ...
 *  are typically fine. For example below is a user-specific views counter:
 *
 *       connect()
 *         .use(connect.favicon())
 *         .use(connect.cookieParser())
 ...
 *    - `.clear(callback)`
 *
 * For an example implementation views the [connect-redis](http://github.com/visionmedia/connect-redis) repo.
 *
