        ...
        init: function () {
            ...
            function k(a) {
                switch (h(), $flicker_width = r.width(), q.flick_animation) {
                    ...
                    case"jquery-slide":
                        $pos_x = Math.round(a.gesture.deltaX / $flicker_width * 100) + w, 1 == q.flick_position && $pos_x > 0 ? $pos_x = 0 : q.flick_position == u && -(100 * (u - 1)) > $pos_x && ($pos_x = -(100 * (u - 1))), r.find("ul.flicks").attr({style: "left:" + $pos_x + "%;"})
                }
            }
            ...
            function n() {
                switch ($position = q.flick_position - 1, q.flick_animation) {
                    case"transform-slide":
                        r.find("ul.flicks").attr({style: "-webkit-transform:translate3d(-" + $position + "%, 0, 0);-o-transform:translate3d(-" + $position + "%, 0, 0);-moz-transform:translate3d(-" + $position + "%, 0, 0);transform:translate3d(-" + $position + "%, 0, 0)"}), x = -$position;
                        break;
                    case"transition-slide":
                        r.find("ul.flicks").attr({style: "left:-" + $position + "00%;"}), w = -($position + "00");
                        break;
                    case"jquery-slide":
                        r.find("ul.flicks").animate({left: "-" + $position + "00%"}, function () {
                            v = !1
                        }), w = -($position + "00");
                        break;
                    case"transition-fade":
                        ...
                        break;
                    case"jquery-fade":
                        $pre_position = parseInt(r.attr("data-flick-position")) - 1, $pre_position === $position ? r.find("ul.flicks li:gt(" + $pre_position + ")").css("display", "none") : r.find("ul.flicks li:eq(" + $pre_position + ")").animate({opacity: 0}, q.fade_speed, function () {
                            a(this).css("display", "none")
                        }), r.find("ul.flicks li:eq(" + $position + ")").css("display", "").animate({opacity: 1}, q.fade_speed);
                        break;
                    default:
                        r.find("ul.flicks").attr({style: "-webkit-transform:translate3d(-" + $position + "%, 0, 0);-o-transform:translate3d(-" + $position + "%, 0, 0);-moz-transform:translate3d(-" + $position + "%, 0, 0);transform:translate3d(-" + $position + "%, 0, 0)"})
                }
            ...
            var o, p = this, q = p.settings, r = a(p.element), s = 0, t = 800, u = 0, v = !1, w = 0, x = 0, y = "translate3d(0, 0, 0)", z = 100;
